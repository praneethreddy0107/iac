...
locals {
  ...
  new_dataset_id = (var.bq_create ?
    try(google_bigquery_dataset.main, null) :
  try(data.google_bigquery_dataset.datasets, null))
}
data "google_bigquery_dataset" "datasets" {
  count      = var.bq_create ? 0 : 1
...
resource "google_bigquery_table" "main" {
  ...
  dataset_id               = local.new_dataset_id[0].dataset_id
...
resource "google_bigquery_table" "view" {
  ...
  dataset_id          = local.new_dataset_id
